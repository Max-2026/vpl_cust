...
<div class="fixed z-10 inset-0 overflow-y-auto" aria-labelledby="modal-title" role="dialog" aria-modal="true">
  ...
  <div class="bg-white rounded-md p-4 absolute z-10 top-1/2 left-1/2 transform -translate-y-1/2 -translate-x-1/2 w-11/12 max-w-lg lg:max-w-3xl">
    ...
    <div class="w-full mt-6 px-2">
      ...
      <form class="mt-5 flex flex-col gap-y-4">
        ...
        @if (count($user->payment_methods ?? []) > 0)
        <div class="border rounded-md sm:overflow-hidden hidden">
        @else
          ...
          <div class="bg-white py-6 px-4 sm:p-6">
            ...
            <div class="mt-6 grid grid-cols-4 gap-6">
              <div class="col-span-4 sm:col-span-2">
                ...
                <input type="text" name="last-name" id="last-name" autocomplete="cc-family-name" class="mt-1 block w-full border border-gray-300 rounded-md py-2 px-3 focus:outline-none focus:ring-gray-900 focus:border-gray-900 sm:text-sm">
              </div>

              <div class="col-span-4 sm:col-span-1">
                <label for="expiration-date" class="block text-sm font-medium text-gray-700">Expration date</label>
                <input type="text" name="expiration-date" id="expiration-date" autocomplete="cc-exp" class="mt-1 block w-full border border-gray-300 rounded-md py-2 px-3 focus:outline-none focus:ring-gray-900 focus:border-gray-900 sm:text-sm" placeholder="MM / YY">
              </div>
              ...
              <div class="col-span-4 sm:col-span-1">
                ...
                <input type="text" name="security-code" id="security-code" autocomplete="cc-csc" class="mt-1 block w-full border border-gray-300 rounded-md py-2 px-3 focus:outline-none focus:ring-gray-900 focus:border-gray-900 sm:text-sm">
              </div>

              <div class="col-span-4 sm:col-span-2">
                <label for="first-name" class="block text-sm font-medium text-gray-700">Cardholder name</label>
                <input type="text" name="first-name" id="first-name" autocomplete="cc-given-name" class="mt-1 block w-full border border-gray-300 rounded-md py-2 px-3 focus:outline-none focus:ring-gray-900 focus:border-gray-900 sm:text-sm">
              </div>
        ...
        <div class="px-4 py-3 bg-gray-50 flex items-center gap-x-4 sm:px-6">
          ...
          <p class="mx-auto text-gray-700">Or Pay With</p>
