    ...
    <form method="POST" action="{{ route('signup_post') }}">
      ...
      <div class="form-row">
        <div class="form-group col-md-6">
          <input required type="email" class="form-control" name="email" placeholder="* Email" value="{{ old('email') }}">
      ...
      <div class="form-row">
        <div class="form-group col-md-6">
          <input required type="text" class="form-control" name="first_name" placeholder="* First Name" value="{{ old('first_name') }}">
          <span class="input-icon"><i class="fa fa-user"></i></span>
        </div>
        <div class="form-group col-md-6">
          <input required type="text" class="form-control" name="last_name" placeholder="* Last Name" value="{{ old('last_name') }}">
          <span class="input-icon"><i class="fa fa-user"></i></span>
        </div>
      </div>
      <div class="form-row">
        <div class="form-group col-md-6">
          <input type="tel" class="form-control" name="phone_number" placeholder="Phone" value="{{ old('phone_number') }}">
          <span class="input-icon"><i class="fa fa-phone"></i></span>
        </div>
        <div class="form-group col-md-6">
          <input type="tel" class="form-control" name="company_phone" placeholder="Company Phone" value="{{ old('company_phone') }}">
          <span class="input-icon"><i class="fa fa-phone"></i></span>
        </div>
      </div>
      <div class="form-row">
