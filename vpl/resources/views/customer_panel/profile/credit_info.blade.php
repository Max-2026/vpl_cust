                    ...
                    <div class="col-md-8 mx-auto">
                        ...
                        <form id="form2" style="display: none;">
                          ...
                          <form id="form3" style="display: none;">
                              ...
                              <div class="form-group row mb-0">
                                  <label for="id"
                                      class="col-sm-3 col-form-label text-left">House/Apartment</label>
                                  <div class="col-sm-9 mt-2">
                                      <!-- <input class="form-control col-md-8 mx-auto" type="text" id="id" value="	H#23 " > -->
                              ...
                              <div class="form-group row mb-0">
                                  <label for="id" class="col-sm-3 col-form-label text-left">Credit Card
                                      Expiry</label>
                                  <div class="col-sm-9 mt-2">
                                      <input class="form-control col-md-8 mx-auto" type="date" id="id"
                                          value="H#23">
                                  </div>
                              </div>
                              <div class="form-group row mb-0">
                    ...
                    <div class=" d-flex justify-content-between mt-0">
                        ...
                        <div class="media mr-2 card-text mr-5 ">
                            ...
                            <div class="media-body mt-1">
                                <p class="">Your profile is currently not linked with your Gmail ID <br> <a
                                        class="a_tag" href="#">Click here to login Gmail account</a> </p>
                                <hr class="my-1 mx-3">
                            </div>
                        </div>
                    </div>
