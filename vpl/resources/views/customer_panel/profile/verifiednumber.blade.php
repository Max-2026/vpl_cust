@extends('layout')
@section('verified_number')
@section('title', 'Verified Number')
<br>
<br>
        ...
        <div class="card-body text-center">
         ...
         <form>
          <div class="form-group row mb-0">
            ...
            <label for="id" class="col-sm-3 col-form-label text-left">Enter Mobile Number</label>
            <div class="col-sm-9">
              <input class="form-control col-md-8 mx-auto" type="text" placeholder="Example : +923322950760" id="id" required>
            </div>
          </div>
          <br>
