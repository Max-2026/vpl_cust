      ...
      <div class="card rounded">
        ...
        <div class="card-body text-center">
          <div class="form-group row">
            ...
            <div class="col-sm-9">
              <input class="form-control col-md-6 mx-auto" type="text" id="id" value="1005729" readonly>
            </div>
          </div>
          <div class="form-group row">
            <!-- Right-align labels by adding text-end class -->
            ...
            <div class="col-sm-9">
              <input class="form-control col-md-6 mx-auto" type="text" id="firstName" value="Ahmed">
            </div>
          </div>
          ...
          <div class="form-group row">
            ...
            <div class="col-sm-9">
              <input class="form-control col-md-6 mx-auto" type="text" id="lastName" value="Raza">
            </div>
          </div>
          <div class="form-group row">
            <!-- Right-align labels by adding text-end class -->
            ...
            <div class="col-sm-9">
              <input class="form-control col-md-6 mx-auto" type="text" id="email" value="Smi">
            </div>
          </div>
          <!-- Right-align labels by adding text-end class -->
          <div class="form-group row">
            <label for="company" class="col-sm-3 col-form-label text-end">Company</label>
            <div class="col-sm-9">
              <input class="form-control col-md-6 mx-auto" type="text" id="company" value="----">
            </div>
          </div>
          <!-- Right-align labels by adding text-end class -->
          <div class="form-group row">
            ...
            <div class="col-sm-9">
              <input class="form-control col-md-6 mx-auto" type="password" id="password" value="**********">
            </div>
          </div>
          <!-- Right-align labels by adding text-end class -->
          <div class="form-group row">
            <label for="language" class="col-sm-3 col-form-label text-end">Language</label>
            <div class="col-sm-9">
              <input class="form-control col-md-6 mx-auto" type="text" id="language" value="English">
            </div>
          </div>
